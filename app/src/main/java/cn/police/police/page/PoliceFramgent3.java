...
public class PoliceFramgent3 extends FrameLayout {
    ...
    public static PoliceFramgent3 newInstance() {
        PoliceFramgent3 fragment = new PoliceFramgent3(null);


        return fragment;
    }
    public PoliceFramgent3(Context context) {
        super(context);
    ...
    public interface OnDateTimeChangedListener {
        void onDateTimeChanged(PoliceFramgent3 view, int year, int month, int day,int hour,int minute);
    }
